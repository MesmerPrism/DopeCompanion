...
function renderPage(page, pages) {
    ...
    const runtimeConfigPage = pages.find(candidate => candidate.relativePath === "runtime-config.md");
    const topNav = [
        homePage,
        downloadPage,
        firstSessionPage,
    ...
    const heroAside = focusedLayout
        ...
        <p class="aside-note">This repo is the public Windows operator surface. The Unity runtime and APK authoring stay in the separate Dynamic Oscillatory Pattern Entrainment repo.</p>
      </aside>`;
...
<head>
  ...
  <title>${escapeHtml(page.title)} | DOPE Companion</title>
