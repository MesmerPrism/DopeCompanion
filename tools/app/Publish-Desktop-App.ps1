...
function Remove-StaleRepoExecutables {
    ...
    $repoExes = Get-ChildItem -Path $RepoRoot -Recurse -File -Filter 'DopeCompanion.exe' -ErrorAction SilentlyContinue
...
Write-Host "Publishing DOPE Companion to $outputPath" -ForegroundColor Cyan
& dotnet @publishArgs
