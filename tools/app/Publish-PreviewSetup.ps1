...
$projectPath = Join-Path $repoRoot 'src\DopeCompanion.PreviewInstaller\DopeCompanion.PreviewInstaller.csproj'
...
$publishedExe = Join-Path $publishPath 'DopeCompanion.PreviewInstaller.exe'
