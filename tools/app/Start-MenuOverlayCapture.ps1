...
function Resolve-AdbSelector {
    ...
    $sessionPath = Join-Path $env:LOCALAPPDATA 'DopeCompanion\session\app-state.json'
...
$cliDll = Join-Path $repoRoot 'src\DopeCompanion.Cli\bin\Release\net10.0\dope-companion.dll'
