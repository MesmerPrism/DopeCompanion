...
public class ConfigHotloadTests
{
    ...
    private const string StudyPackage = "com.tillh.dynamicoscillatorypatternentrainment";
    private const string StudyLaunchComponent = "com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity";
    private const string RemoteHotloadDir = "/sdcard/Android/data/com.tillh.dynamicoscillatorypatternentrainment/files/runtime_hotload";
    ...
    public async Task Push_baseline_profile_and_relaunch()
    {
        ...
        var profilePath = FindHotloadProfile("dope_baseline.csv");
        if (profilePath is null) return;
    ...
    public async Task TwinBridge_publishes_config_snapshot_via_lsl()
    {
        ...
        var profile = new RuntimeConfigProfile(
            "dope_baseline", "DOPE Baseline", "dope_baseline.csv", "1.0", "release", false,
        ...
        var target = new QuestAppTarget(
            "dope-experiment", "Dope Experiment", StudyPackage, "", "", "", "", []);
