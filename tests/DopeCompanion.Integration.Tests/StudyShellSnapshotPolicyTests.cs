...
public sealed class StudyShellSnapshotPolicyTests
{
    ...
    public void ShouldRefreshInstalledAppStatusForSnapshot_RefreshesWhenForced()
    {
        ...
        var shouldRefresh = StudyShellViewModel.ShouldRefreshInstalledAppStatusForSnapshot(
            forceRefresh: true,
            currentStatus,
            currentStagedApkPath: @"C:\staged\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk",
            lastQueriedStagedApkPath: @"C:\staged\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk");
    ...
    public void ShouldRefreshInstalledAppStatusForSnapshot_SkipsAutomaticRefreshWhenStatusAndStagedApkAreUnchanged()
    {
        ...
        var shouldRefresh = StudyShellViewModel.ShouldRefreshInstalledAppStatusForSnapshot(
            forceRefresh: false,
            currentStatus,
            currentStagedApkPath: @"C:\bundle\..\bundle\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk",
            lastQueriedStagedApkPath: @"C:\bundle\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk");
    ...
    public void ShouldRefreshInstalledAppStatusForSnapshot_RefreshesWhenStagedApkChanges()
    {
        ...
        var shouldRefresh = StudyShellViewModel.ShouldRefreshInstalledAppStatusForSnapshot(
            forceRefresh: false,
            currentStatus,
            currentStagedApkPath: @"C:\bundle\DopeExperiment-v2.apk",
            lastQueriedStagedApkPath: @"C:\bundle\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk");
    ...
    public void ShouldRefreshInstalledAppStatusForSnapshot_RefreshesWhenNoPriorStatusExists()
    {
        var shouldRefresh = StudyShellViewModel.ShouldRefreshInstalledAppStatusForSnapshot(
            forceRefresh: false,
            currentStatus: null,
            currentStagedApkPath: @"C:\bundle\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk",
            lastQueriedStagedApkPath: @"C:\bundle\DynamicOscillatoryPatternEntrainment-ProjectedFeedColoramaQuad.apk");
