...
public class HzdbCommandTests
{
    ...
    private const string StudyFilesDir = "/sdcard/Android/data/com.tillh.dynamicoscillatorypatternentrainment/files/";
    ...
    public async Task Hzdb_capture_screenshot()
    {
        ...
        var tempDir = Path.Combine(Path.GetTempPath(), $"dope-test-{Guid.NewGuid():N}");
