...
public sealed class StudyDataRecorderServiceTests
{
    ...
    public void GetParticipantStatus_FindsExistingParticipantSessions()
    {
        ...
        try
        {
            var participantRoot = Path.Combine(root, "dope-projected-feed-colorama", "participant-P001");
            ...
            var status = service.GetParticipantStatus("dope-projected-feed-colorama", "P001");
    ...
    public void StartSession_WritesSettingsEventsSignalsAndBreathingFiles()
    {
        ...
        try
        {
            ...
            Assert.Contains("dope-projected-feed-colorama__P007__session-20260329T123456Z", eventLines[1], StringComparison.Ordinal);
            ...
            Assert.Equal("dope-projected-feed-colorama__P007__session-20260329T123456Z", rootElement.GetProperty("DatasetId").GetString());
            ...
            Assert.Equal("com.tillh.dynamicoscillatorypatternentrainment", rootElement.GetProperty("PackageId").GetString());
            Assert.Equal("CONFIG_HASH", rootElement.GetProperty("RuntimeConfigJsonHash").GetString());
            Assert.Equal("dope_projected_feed_colorama_baseline", rootElement.GetProperty("RuntimeHotloadProfileId").GetString());
            ...
            Assert.Equal(DopeClockAlignmentStreamContract.DefaultBackgroundProbeIntervalSeconds, rootElement.GetProperty("ClockAlignmentBackgroundProbeIntervalSeconds").GetInt32());
            ...
            Assert.Equal("dope-session-snapshot-v1", snapshotRoot.GetProperty("SchemaVersion").GetString());
            Assert.Equal("P007", snapshotRoot.GetProperty("Settings").GetProperty("ParticipantId").GetString());
            Assert.Equal(
                "dope-session-conditions-v1",
    ...
    private static StudyDataRecordingStartRequest CreateRequest(
        ...
        => new(
            "dope-projected-feed-colorama",
            "Dope University",
            participantId,
            sessionId,
            "dope-projected-feed-colorama__P007__session-20260329T123456Z",
            "DATASET_HASH",
            "SETTINGS_HASH",
            "ENV_HASH",
            startedAtUtc,
            ...
            "ABC123",
            "0.2.0",
            "com.tillh.dynamicoscillatorypatternentrainment/.MainActivity",
            "14",
            "2921110053000610",
            "UP1A.231005.007.A1",
            "dope-study-profile",
            "Dope Study Device Profile",
            ...
            0.2d,
            "CONFIG_HASH",
            "dope_projected_feed_colorama_baseline",
            "2026.03.29",
            "public",
            "study-rig",
            "Quest-Selector-01",
