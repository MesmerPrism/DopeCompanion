...
public sealed class WindowsAdbQuestControlServiceTests
{
    ...
    {
        var paths = WindowsAdbQuestControlService.BuildRuntimeHotloadRemotePaths("com.tillh.dynamicoscillatorypatternentrainment");

        Assert.Equal(
            "/sdcard/Android/data/com.tillh.dynamicoscillatorypatternentrainment/files/runtime_hotload",
    ...
    public void MergeWakeWarning_upgrades_success_to_warning_and_keeps_command_summary()
    {
        var wakeOutcome = new OperationOutcome(
            ...
            "Wake before launching Dope Controller Study APK left the headset blocked.",
        ...
        var launchOutcome = new OperationOutcome(
            ...
            "Launch command sent for Dope Controller Study APK.",
            "Events injected: 1");
    ...
    public void MergeWakeWarning_leaves_failure_kind_unchanged()
    {
        var wakeOutcome = new OperationOutcome(
            OperationOutcomeKind.Warning,
            "Wake before stopping Dope Controller Study APK left the headset blocked.",
        ...
        var stopOutcome = new OperationOutcome(
            ...
            "Stop failed for Dope Controller Study APK.",
            "device offline");
    ...
    public void BuildSleepBlockedLaunchOutcome_requires_waking_before_launch()
    {
        ...
        Assert.Equal("Launch blocked for Dope Experiment.", outcome.Summary);
    ...
    {
        const string output = """
            topResumedActivity=ActivityRecord{c61340f u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t8083}
        ...
        Assert.False(WindowsAdbQuestControlService.IsPinnedForegroundForPackage(evidence, "com.tillh.dynamicoscillatorypatternentrainment"));
    }
    ...
    {
        const string output = """
            topResumedActivity=ActivityRecord{e631854 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t8086}
            ResumedActivity: ActivityRecord{e631854 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t8086}
            mCurrentFocus=Window{c420b05 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity}
            mFocusedApp=ActivityRecord{e631854 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t8086}
            mFocusedWindow=Window{c420b05 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity}
            mTopFullscreenOpaqueWindowState=Window{c420b05 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity}
            mLockTaskModeState=PINNED
            """;

        var evidence = WindowsAdbQuestControlService.ParseKioskForegroundEvidence(output);

        Assert.True(WindowsAdbQuestControlService.IsSettledForegroundForPackage(evidence, "com.tillh.dynamicoscillatorypatternentrainment"));
        Assert.True(WindowsAdbQuestControlService.IsPinnedForegroundForPackage(evidence, "com.tillh.dynamicoscillatorypatternentrainment"));
    }
    ...
    public void IsHomeForegroundAfterExit_accepts_home_shell_foreground()
    {
        ...
        Assert.True(WindowsAdbQuestControlService.IsHomeForegroundAfterExit(evidence, "com.tillh.dynamicoscillatorypatternentrainment"));
    }
