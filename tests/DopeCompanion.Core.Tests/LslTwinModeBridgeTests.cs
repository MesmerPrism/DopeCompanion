...
public class LslTwinModeBridgeTests
{
    ...
    public async Task ConfigureExpectedQuestStateSource_applies_package_bound_source_filter()
    {
        ...
        bridge.ConfigureExpectedQuestStateSource("com.tillh.dynamicoscillatorypatternentrainment");
        bridge.Open();
        await Task.Delay(50);
        ...
        Assert.Equal("dope.quest.", stateMonitor.LastSubscription?.SourceIdPrefix);
    }
