...
public sealed class AdbShellSupportTests
{
    ...
    {
        const string output = """
        topResumedActivity=ActivityRecord{12345 u0 org.tillh.dope.preview/com.unity3d.player.UnityPlayerActivity t12}
        """;

        var packageId = AdbShellSupport.ParseForegroundPackage(output);

        Assert.Equal("org.tillh.dope.preview", packageId);
    }
    ...
    {
        const string output = """
        package:org.tillh.dope.preview
        ...
        Assert.Contains("org.tillh.dope.preview", packages);
    ...
    {
        const string output = """
        mFocusedApp=AppWindowToken{def5678 token=Token{aaa u0 org.tillh.dope.twin/com.unity3d.player.UnityPlayerActivity}}
        """;

        var packageId = AdbShellSupport.ParseForegroundPackage(output);

        Assert.Equal("org.tillh.dope.twin", packageId);
    }
    ...
    {
        const string output = """
        Window #1 Window{fa4f5ee u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity}:
        """;

        var packageId = AdbShellSupport.ParseForegroundPackage(output);

        Assert.Equal("com.tillh.dynamicoscillatorypatternentrainment", packageId);
    }
    ...
    {
        const string output = """
        topResumedActivity=ActivityRecord{9dc95ae u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t5527}
        ...
        Assert.Equal("com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity", components[0]);
    ...
    {
        const string output = """
        topResumedActivity=ActivityRecord{c61340f u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t5749}
        topResumedActivity=ActivityRecord{f3d8c93 u0 com.oculus.os.vrlockscreen/.SensorLockActivity t5709}
        ResumedActivity: ActivityRecord{c61340f u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t5749}
        mCurrentFocus=Window{461264c u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity}
        mFocusedApp=ActivityRecord{c61340f u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t5749}
        """;

        var snapshot = AdbShellSupport.ParseForegroundSnapshot(output);

        Assert.NotNull(snapshot);
        Assert.Equal("com.tillh.dynamicoscillatorypatternentrainment", snapshot!.PackageId);
        Assert.Equal("com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity", snapshot.PrimaryComponent);
    ...
    {
        const string output = """
        mTopFullscreenOpaqueOrDimmingWindowState=WindowState{abcd u0 org.tillh.dope.preview/com.unity3d.player.UnityPlayerActivity}
        """;
    ...
    {
        const string output = """
        * Recent #3: Task{f7032e0 #6247 type=standard A=10237:com.tillh.dynamicoscillatorypatternentrainment}
        ...
        * Recent #4: Task{7a32bb6 #6246 type=standard A=10043:com.oculus.systemux:2065988206}
        ...
        var taskId = AdbShellSupport.ParseRecentTaskId(output, "com.tillh.dynamicoscillatorypatternentrainment");
    ...
    public void ParseRecentTaskId_IgnoresCallingUidInsideMatchingTaskBlock()
    {
        ...
        ACTIVITY MANAGER RECENT TASKS (dumpsys activity recents)
          Recent tasks:
          * Recent #0: Task{1814e4e #6668 type=standard A=10237:com.tillh.dynamicoscillatorypatternentrainment}
            ...
            affinity=10237:com.tillh.dynamicoscillatorypatternentrainment
            intent={act=android.intent.action.MAIN cat=[android.intent.category.LAUNCHER] flg=0x10a10100 cmp=com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity}
            mActivityComponent=com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity
            rootWasReset=true mNeverRelinquishIdentity=true mReuseTask=false mLockTaskAuth=LOCK_TASK_AUTH_PINNABLE
            Activities=[ActivityRecord{1bb2549 u0 com.tillh.dynamicoscillatorypatternentrainment/com.unity3d.player.UnityPlayerGameActivity t6668}]
