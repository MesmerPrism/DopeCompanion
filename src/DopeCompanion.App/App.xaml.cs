...
{
    public const string SuppressStartupWindowEnvironmentVariable = "DOPE_SUPPRESS_STARTUP_WINDOW";
    ...
    private void OnDispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
    {
        ...
        MessageBox.Show(
            $"DOPE Companion hit an unhandled error and needs to close.{Environment.NewLine}{Environment.NewLine}{e.Exception.Message}{Environment.NewLine}{Environment.NewLine}Crash log: {logPath}",
            "DOPE Companion",
            MessageBoxButton.OK,
