...
internal sealed record DopeControllerBreathingProfileSnapshot(
    DopeControllerBreathingProfileListItemViewModel Profile,
    string ProfileName,
    string? ProfileNotes,
    IReadOnlyDictionary<string, double> ControlValues);

internal sealed record DopeControllerBreathingStartupHotloadPlan(
    DopeControllerBreathingProfileRecord Profile,
    IReadOnlyList<RuntimeConfigEntry> Entries,
    IReadOnlyDictionary<string, double?> PreviousReportedValues);

public readonly record struct DopeControllerBreathingRowConfirmationState(
    string Label,
    OperationOutcomeKind Level);

internal sealed record DopeControllerBreathingRowConfirmationComputationResult(
...
internal static class DopeControllerBreathingRowConfirmationResolver
{
    public static DopeControllerBreathingRowConfirmationComputationResult Compute(
        IEnumerable<DopeControllerBreathingProfileFieldViewModel> fields,
        DopeControllerBreathingProfileApplyRecord applyRecord,
        IReadOnlyDictionary<string, DopeControllerBreathingConfirmationRow> confirmationRows)
    {
        ArgumentNullException.ThrowIfNull(fields);
        ArgumentNullException.ThrowIfNull(applyRecord);
        ArgumentNullException.ThrowIfNull(confirmationRows);

        var states = new Dictionary<string, DopeControllerBreathingRowConfirmationState>(StringComparer.OrdinalIgnoreCase);
        ...
        return new DopeControllerBreathingRowConfirmationComputationResult(states, changedSinceApplyCount, unchangedSinceApplyCount);
    }

    public static DopeControllerBreathingRowConfirmationState BuildConfirmationState(
        DopeControllerBreathingConfirmationRow confirmationRow)
        => new(
            confirmationRow.State switch
            {
                DopeControllerBreathingConfirmationState.Confirmed => "Confirmed",
                DopeControllerBreathingConfirmationState.Mismatch => "Mismatch",
                _ => "Waiting"
            },
            confirmationRow.State switch
            {
                DopeControllerBreathingConfirmationState.Confirmed => OperationOutcomeKind.Success,
                DopeControllerBreathingConfirmationState.Mismatch => OperationOutcomeKind.Warning,
                _ => OperationOutcomeKind.Warning
            });

    public static DopeControllerBreathingRowConfirmationState DefaultConfirmationState
        => new("Not applied", OperationOutcomeKind.Preview);

    public static DopeControllerBreathingRowConfirmationState EditedConfirmationState
        => new("Edited", OperationOutcomeKind.Warning);

    private static bool ValuesMatch(
        DopeControllerBreathingProfileFieldViewModel field,
        double currentValue,
...
internal static class DopeControllerBreathingStartupSnapshotResolver
{
    public static DopeControllerBreathingTuningDocument ResolveDocument(
        DopeControllerBreathingTuningCompiler compiler,
        DopeControllerBreathingProfileStartupState? startupState,
        DopeControllerBreathingTuningDocument? legacyPinnedDocument)
    {
    ...
    public static bool MatchesCurrentSelection(
        ...
        DopeControllerBreathingTuningDocument currentSelectedDocument,
        DopeControllerBreathingTuningDocument? legacyPinnedDocument)
    {
        ArgumentNullException.ThrowIfNull(compiler);
...
internal static class DopeControllerBreathingCurrentDocumentResolver
{
...
internal static class DopeControllerBreathingComparisonRowBuilder
{
    public static IReadOnlyList<DopeControllerBreathingComparisonRow> Build(
        DopeControllerBreathingTuningCompiler compiler,
        IEnumerable<DopeControllerBreathingProfileFieldViewModel> fields,
        DopeControllerBreathingTuningDocument? compareDocument = null)
    {
        ...
        var rows = new List<DopeControllerBreathingComparisonRow>(compiler.TemplateDocument.Controls.Count);
...
public sealed class DopeControllerBreathingProfileListItemViewModel : ObservableObject
{
    private DopeControllerBreathingProfileRecord _record;
    private readonly string? _modifiedLabelOverride;

    public DopeControllerBreathingProfileListItemViewModel(
    ...
    public DopeControllerBreathingTuningDocument Document => _record.Document;
    ...
    public void Apply(DopeControllerBreathingProfileRecord record)
    {
        _record = record;
    ...
    public DopeControllerBreathingProfileRecord ToRecord() => _record;

    public override string ToString() => DisplayLabel;
}

public sealed class DopeControllerBreathingProfileGroupViewModel
{
    public DopeControllerBreathingProfileGroupViewModel(string title)
    {
        Title = title;
    }

    public string Title { get; }
    public ObservableCollection<DopeControllerBreathingProfileFieldViewModel> Fields { get; } = new();
}

public sealed class DopeControllerBreathingProfileFieldViewModel : ObservableObject
{
    ...
    public DopeControllerBreathingProfileFieldViewModel(
    ...
    private static string BuildToolTip(DopeControllerBreathingTuningControl control)
    {
...
public sealed class DopeControllerBreathingComparisonRowViewModel : ObservableObject
{
    private readonly DopeControllerBreathingProfileFieldViewModel _field;
    ...
    public DopeControllerBreathingComparisonRowViewModel(
        DopeControllerBreathingProfileFieldViewModel field,
        DopeControllerBreathingComparisonRow comparison,
        DopeControllerBreathingRowConfirmationState confirmation)
    {
        _field = field;
    ...
    public DopeControllerBreathingProfileFieldViewModel Field => _field;
    public string Group { get; }
    public string Label { get; }
    public string ToolTipText { get; }
