    ...
    [
        ...
        new(
            ...
            [
                ...
                Toggle("projected_feed_pre_strength_brightness_blur", "Pre-Brightness Blur", "Blur the brightness field before brightness-map extraction.", true),
                Text("projected_feed_pre_brightness_blur_radius_texels", "Pre-Brightness Blur Radius", "Radius for the first brightness blur pass before the brightness map is derived.", "2.5"),
                Text("projected_feed_pre_brightness_blur_sigma", "Pre-Brightness Blur Sigma", "Sigma for the first brightness blur pass before the brightness map is derived.", "0.75"),
                Choice("projected_feed_displacement_blur_kernel", "Displacement Blur Kernel", "Projected-feed blur kernel enum.", "1", ["0", "1", "2"]),
                Text("projected_feed_displacement_blur_radius_texels", "Post-Brightness Blur Radius", "Radius for the second brightness blur pass that shapes the blurred brightness layer and composite displacement.", "4.0"),
                Text("projected_feed_displacement_blur_sigma", "Post-Brightness Blur Sigma", "Sigma for the second brightness blur pass that shapes the blurred brightness layer and composite displacement.", "1.0"),
        ...
        new(
            ...
            [
                ...
                Choice("projected_feed_focus_layer", "Focus Layer", "Focused cast layer. -1 auto cycle, 0 final composite, 1 raw feed, 2 pre-blurred brightness, 3 raw brightness, 4 blurred brightness, 5 depth visualization.", "-1", ["-1", "0", "1", "2", "3", "4", "5"]),
