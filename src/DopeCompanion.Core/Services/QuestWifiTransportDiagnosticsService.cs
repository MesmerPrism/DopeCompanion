        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!OperatingSystem.IsWindows())
        {
            return new QuestWifiTransportDiagnosticsResult(
                ...
                "The current Dope operator transport diagnostics only ship on Windows.",
        ...
        else if (!tcpProbe.Reachable)
        {
            ...
            detailParts.Add(headset.WifiSsidMatchesHost == true
                ...
                : "Without a working TCP path to port 5555, Wi-Fi ADB recovery, probe actions, and Dope relaunches will be unreliable.");
        }
        ...
        else if (pingProbe.Reachable == false)
        {
            ...
            detailParts.Add("TCP 5555 is working, so Wi-Fi ADB can still function. The missing ping replies usually point to router/firewall ICMP policy rather than a broken Dope path.");
        }
