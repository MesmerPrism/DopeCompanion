...
DopeCompanion is a public Windows-facing operator shell for the broader
Dope workflow. Keep changes focused on the public interface surface:
...
- `src/DopeCompanion.Private/`
- `tests/DopeCompanion.Private.Tests/`
- `private/`
